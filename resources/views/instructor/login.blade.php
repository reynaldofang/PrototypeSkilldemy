...
<main id="main" class="main-background" >
    ...
    <form action="{{route () }}" method="POST" class="main-account needs-validation" novalidate>
        @csrf
        ...
        <div class="form-group">
            <p class="p-color">Don't have an account? <a href="/instructor-register">Register Here</a></p>
        </div>
    </form>
</main>
